...
// ContainerInstancePropagateTagsType is an enum variable type corresponding to different
// ways to propagate tags, it includes none (default) and ec2_instance.
type ContainerInstancePropagateTagsType int8
...
type Config struct {
	...
	// ContainerInstancePropagateTags when set to "ec2_instance", agent will call EC2 API to
	...
	ContainerInstancePropagateTags ContainerInstancePropagateTagsType
